          ...
          <div class="row">
            ...
            <table class="table table-striped table-condensed table-bordered" id="man">
                    ...
                    <tr>
                        ...
                        <th style="width:100px"><b>SERIAL NO</b></th>
                        <th><b>DEPARTMENT</b></th>
                        <th><b>USERNAME</b></th>
                        <th style="width:150px"><b>ISSUE</b></th>
                        <th><b>RESOLUTION</b></th>
                        <th><b>DATE REPAIRED</b></th>
                        <th><b>DATE DISPATCHED</b></th>
                        <th><b>TECHNICHIAN</b></th>
                        <th><b>DELETE</b></th>
                        <th><b>EDIT</b></th>
                ...
                if($num > 0){
                    ...
                    while($row = mysqli_fetch_array($result,MYSQLI_ASSOC)){
                         if($row['DATE_DISPATCHED']=='0000-00-00'){
                            $row['DATE_DISPATCHED']='<label class="label label-info label-xs">Pending</label>';}
                        if($row['DATE_REPAIRED']=='0000-00-00') {
                                     $row['DATE_REPAIRED']='<label class="label label-info label-xs">Pending</label>';}
                        if ($row['TECHNICHIAN']=='') {
                                $row['TECHNICHIAN']='<label class="label label-info label-xs">Pending</label>';}
                        if ($row['ISSUE']=='') {
                                $row['ISSUE']='<label class="label label-info label-xs">Pending</label>';
                        }
                        if ($row['RESOLUTION']=='') {
                                $row['RESOLUTION']='<label class="label label-info label-xs">Pending</label>';
                        }
                        $html.='<tr>
                                ...
                                <td>'.$row['DATE_REPAIRED'].'</td>
                                <td>'.$row['DATE_DISPATCHED'].'</td>
                                <td>'.$row['TECHNICHIAN'].'</td>
 ...
 <!--         <div class="table-responsive" style="overflow:auto;height:500px">
        <table class="table table-striped">
            ...
            <tbody>
                <tr>
                    <td>1</td>
                    <td>Andrews baffour agyei hfhjghfgohomhfgufjyhjh</td>
                    <td>Baffour andrews agye</td>
                    <td>Agyei</td>
